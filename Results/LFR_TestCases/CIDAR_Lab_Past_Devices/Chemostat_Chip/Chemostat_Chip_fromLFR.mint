...
CHANNEL channel_1 from mixer_1 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_2 from mixer_2 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_3 from mixer_3 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_4 from mixer_4 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_5 from mixer_5 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_6 from mixer_6 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_7 from mixer_7 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_8 from mixer_8 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_9 from mixer_9 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_10 from square_cell_trap_2 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_11 from square_cell_trap_3 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_12 from square_cell_trap_4 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_13 from square_cell_trap_1 2 to square_cell_trap_2 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_14 from square_cell_trap_1 2 to square_cell_trap_3 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_15 from square_cell_trap_1 2 to square_cell_trap_4 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_16 from square_cell_trap_1 2 to square_cell_trap_5 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_17 from square_cell_trap_1 2 to square_cell_trap_6 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_18 from square_cell_trap_1 2 to square_cell_trap_7 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_19 from square_cell_trap_1 2 to square_cell_trap_8 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_20 from square_cell_trap_1 2 to square_cell_trap_9 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_21 from square_cell_trap_5 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_22 from square_cell_trap_6 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_23 from square_cell_trap_7 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_24 from square_cell_trap_8 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_25 from square_cell_trap_9 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_26 from mixer_10 2 to mixer_11 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_27 from mixer_14 2 to mixer_10 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
...
CHANNEL channel_29 from mixer_12 2 to mixer_13 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_30 from mixer_15 2 to mixer_16 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_31 from mixer_13 2 to port_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_32 from mixer_16 2 to mixer_17 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_33 from mixer_17 2 to mixer_14 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_34 from port_2 1 to mixer_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_35 from port_3 1 to mixer_7 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
...
CHANNEL channel_37 from port_4 1 to mixer_10 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_38 from port_4 1 to mixer_14 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_39 from port_4 1 to mixer_11 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_40 from port_4 1 to mixer_12 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_41 from port_4 1 to mixer_15 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_42 from port_4 1 to mixer_13 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_43 from port_4 1 to mixer_16 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_44 from port_4 1 to mixer_17 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_45 from port_5 1 to mixer_3 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_46 from port_6 1 to mixer_6 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_47 from port_7 1 to mixer_5 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_48 from port_8 1 to mixer_8 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_49 from port_9 1 to mixer_2 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_50 from port_10 1 to mixer_4 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
...
VALVE3D valve_0 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_1 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_2 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_3 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_4 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_5 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_6 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_7 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_8 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_9 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_10 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_11 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_12 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_13 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_14 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_15 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_16 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_17 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_18 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_19 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_20 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
...
VALVE3D valve_22 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
VALVE3D valve_23 on channel_31 componentSpacing=2000.0 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;

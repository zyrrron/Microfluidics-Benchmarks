...
CHANNEL channel_3 from port_3 1 to nozzle_droplet_generator_2 2 RoundedChannel=True channelWidth=400 connectionSpacing=1000  ;
CHANNEL channel_4 from port_4 1 to nozzle_droplet_generator_2 4 RoundedChannel=True channelWidth=400 connectionSpacing=1000  ;
...
CHANNEL channel_7 from mixer_1 2 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_8 from port_5 1 to nozzle_droplet_generator_2 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
...
CHANNEL channel_10 from port_7 1 to square_cell_trap_1 1 RoundedChannel=True length=1000.0 minChannelLength=1000.0 connectionSpacing=1000 channelWidth=600  ;
